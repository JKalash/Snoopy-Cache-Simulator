...
MemBlock::MemAddress MemBlock::tagFromAddress(MemAddress address) {
...
MemBlock::MemAddress MemBlock::getFullAddress() {return address;}
MemBlock::MemAddress MemBlock::getBlockAddress() { MemAddress copy = address; return copy >> N_SET_ASSOCIATIVE;}
MemBlock::MemAddress MemBlock::getBlockIndex() { MemAddress copy = address;return (copy << (BLOCK_TAG_SIZE)) >> (BLOCK_BYTE_OFFSET_SIZE + BLOCK_TAG_SIZE);}
MemBlock::MemAddress MemBlock::getBlockTag() {return tagFromAddress(this->address);}
